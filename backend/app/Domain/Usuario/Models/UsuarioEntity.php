...
class UsuarioEntity extends BaseModelEntity
{
    ...
    private ?int $totalProdutos = null;
    
    public function getTotalProdutos(): ?int { return $this->totalProdutos; }
    public function setTotalProdutos(?int $total): void { $this->totalProdutos = $total; }
